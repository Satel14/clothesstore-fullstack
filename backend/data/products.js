const products = [
  {
    name: "Кросівки ZX 1 000 Originals FX6947",
    imageUrl:
      "https://assetmanagerpim-res.cloudinary.com/images/w_600/q_90/3cee49bcf4424a7c9fdbac6300d3bc0b_9366/FX6947_01_standard.WebP",
    description:
      "КРОСУВАННЯ ZX 1 000 ЛЕГЕНДАРНІ КРОСУВАННЯ ZX З АРХІВІВ ADIDAS.Повернися у 80-ті у цих кросівках adidas. Точніше, 1989 року. Коли дебютувала перша модель із серії ZX 1000. Ця пара є її точним перевиданням. Включаючи стабілізуючу вставку Torsion, сітчастий верх, що дихає, і накладки зі штучної замші.",
    price: 499,
    countInStock: 15,
  },
  {
